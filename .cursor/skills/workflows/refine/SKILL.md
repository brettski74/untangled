...
2. **Classify** the issue: this workflow targets **features**, not bugs. If the issue reads as a defect report, is labelled `bug`, or is otherwise misclassified, **warn** the user and suggest the **diagnose** workflow. If the human **confirms** it should still be treated as a feature (possibly after re-scoping), continue as directed.
